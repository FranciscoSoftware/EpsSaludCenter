...
export default function VerticalTabs():JSX.Element {
  ...
  const getDisplayTabs = (role:number) :JSX.Element[] =>{
    switch(role){
        ...
        case EnumRoles.Doctor:
            return(
                [
                    <Tab key="0" label="Ver Citas" {...a11yProps(0)} />,
                    <Tab key="1" label="Atender Cita" {...a11yProps(1)} />
                ]
            )
        case EnumRoles.Patient:
            return(
                [
                    <Tab key="0" label="Ver Citas" {...a11yProps(0)} />,
                    <Tab key="1" label="Solicitar Cita" {...a11yProps(1)} />
                ]
            )
        default:
        return(
